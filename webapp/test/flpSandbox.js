		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comyedasmmemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyedasmmemployees-display": {
								"semanticObject": "comyedasmmemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yedas.mm.employees",
									"url": sap.ui.require.toUrl("com/yedas/mm/employees")
								}
							}
						}
					}
